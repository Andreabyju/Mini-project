...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->connect_error) {
        ...
        // Debugging: Log the sanitized email
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if ($result && $result->num_rows === 1) {
                ...
                echo'<form id="form" method="POST" action="sentotp.php">';
...
<head>
    ...
    <title>The Canine & Feline Co. - Forgot Password</title>
...
<body>
    <div class="login-container">
        <div class="logo">
            <span class="task"></span><span class="mate">The Canine & Feline Co.</span>
        </div>
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            ...
            <p class="back-to-login">Remember your password? <a href="demo.php">Login here</a></p>
        </form>
    </div>
</body>
</html>