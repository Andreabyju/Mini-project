...
function sendVerificationEmail($recipientEmail, $verificationCode) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'byjuandrea@gmail.com';
        $mail->Password   = 'zcit pblk jktf tehf';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = 587;

        $mail->setFrom('byjuandrea@gmail.com', 'The Canine & Feline Co.');
...
<head>
    ...
    <title>The Canine & Feline Co. - OTP Verification</title>
...
<body>
    <div class="login-container">
        <div class="logo">
            <span class="task">The </span><span class="mate">Canine & Feline Co.</span>
        </div>
