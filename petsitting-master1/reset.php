...
<head>
    ...
    <style>
        * {
        ...
        .task { color:rgb(5, 217, 58); }
        .mate { color:rgb(13, 220, 6); }
...
<body>
    <div class="login-container">
        <div class="logo">
            <span class="task">The Canine & Feline Co.</span><span class="mate"></span>
        </div>
    ...
    function checkPassword() {
        ...
        if (password === '') {
            ...
            passwordError.textContent = "Password must be 8+ characters with uppercase, lowercase, and a number.";
            passwordInput.style.border = "2px solid red";
            return false;
        } else {
    ...
    document.getElementById('resetForm').addEventListener('submit', function(e) {
        let isValid = checkPassword() & checkConfirmPassword();
