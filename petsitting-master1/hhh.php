...
<html lang="en">
  <head>
    <title>The Canine & Feline Co. - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
  ...
  <body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				...
				<li class="nav-item"><a href="demo.php" class="nav-link">Login</a></li>
	...
	<style>
	  .navbar-nav {
		  margin-right: 20px;  /* Moves all nav items left */
		  align-items: center; /* Vertically centers all nav items */
	  }
	  
	  .nav-item .fa-cart-shopping {
		  font-size: 20px; /* Adjusts cart icon size to match other items */
		  vertical-align: middle;
	  }
	  
	  .user-name {
		  font-size: 16px;  /* Adjusts username text size */
		  vertical-align: middle;
	  }
	  ...
	  /* Removed styles for outline box */
	  .nav-link {
		  /* border: 2px solid #000; */ /* Removed black border */
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-11 ftco-animate text-center">
            ...
            <p><a href="about.html" class="btn btn-primary mr-md-4 py-3 px-4">Learn more <span class="ion-ios-arrow-forward"></span></a></p>
          </div>
        </div>
      </div>
    </div>
